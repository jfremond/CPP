...
/*   Updated: 2022/07/24 14:57:23 by jfremond         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap(void) : _name("CT"), _hit_pts(100), _en_pts(100), _atk_dmg(30)
{
	std::cout << BLUE << "ClapTrap " << this->_name << RESET << " default constructor called" << std::endl;
	return ;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hit_pts(100), _en_pts(100), _atk_dmg(30)
{
